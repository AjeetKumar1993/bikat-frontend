...
function handleCheckboxChange(id) {
    ...
    fetch('https://optimum-nebula-433205-b3.uc.r.appspot.com/api/admin/tour/'+id+'/tour-suggestion', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function edit(){
   // document.getElementById("table-container").innerHTML = "";
    fetch('https://optimum-nebula-433205-b3.uc.r.appspot.com/api/admin/tour/list')
        .then(response => response.json())
        .then(result => {
...
//   });
 ...
 document.getElementById('data-table').addEventListener('click', function(e) {
  ...
  function duplicateTour(id){
    ...
    fetch("https://optimum-nebula-433205-b3.uc.r.appspot.com/api/admin/tour/duplicate/"+id, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
  ...
  function duplicateRecord(button) {
    ...
    fetch('https://optimum-nebula-433205-b3.uc.r.appspot.com/api/admin/tour/', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
  ...
  function updateTourDate(id, isActive){
        ...
        fetch('https://optimum-nebula-433205-b3.uc.r.appspot.com/api/admin/tour/'+id+'/date', {
            method: 'PATCH',
            headers: {
                'Content-type': 'application/json; charset=UTF-8' // Indicates the content 
            },
    ...
    function updateTourAddOns(id, isActive){
        ...
        fetch('https://optimum-nebula-433205-b3.uc.r.appspot.com/api/admin/tour/'+id+'/tour-addOns', {
            method: 'PATCH',
            headers: {
                'Content-type': 'application/json; charset=UTF-8' // Indicates the content 
            },
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchOptions() {
        ...
        const optionsUrl = 'https://optimum-nebula-433205-b3.uc.r.appspot.com/api/admin/tour/list';
    ...
    function fetchAndDisplaySavedDates() {
        ...
        const datesUrl = 'https://optimum-nebula-433205-b3.uc.r.appspot.com/api/admin/tour/date';
...
function loadAddOnOptions(data) {
 ...
 document.getElementById('add-date-submit').addEventListener('click', function(event) {
    ...
    const saveUrl = 'https://optimum-nebula-433205-b3.uc.r.appspot.com/api/admin/tour/date';
...
document.getElementById('date-form-submit').addEventListener('click', function(e) {
    ...
    fetch('https://optimum-nebula-433205-b3.uc.r.appspot.com/api/admin/tour/available-date', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
